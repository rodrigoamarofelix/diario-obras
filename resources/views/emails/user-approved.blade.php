...
<head>
    ...
    <title>Conta Aprovada - {{ config("app.name") }}</title>
    <style>
        body {
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="message">
                ...
                <p>É com grande prazer que informamos que sua conta no {{ config("app.name") }} foi <strong>aprovada</strong> com sucesso!</p>
        ...
        <div class="footer">
            <p><strong>{{ config("app.name") }} - Sistema de Gestão de Obras</strong></p>
