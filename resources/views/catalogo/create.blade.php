                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="unidade_medida" name="unidade_medida" required>
                                        ...
                                        <option value="m" {{ old('unidade_medida') == 'm' ? 'selected' : '' }}>Metro</option>
                                        <option value="m²" {{ old('unidade_medida') == 'm²' ? 'selected' : '' }}>Metro Quadrado</option>
                                        <option value="m³" {{ old('unidade_medida') == 'm³' ? 'selected' : '' }}>Metro Cúbico</option>
                                        <option value="l" {{ old('unidade_medida') == 'l' ? 'selected' : '' }}>Litro</option>
                                        <option value="h" {{ old('unidade_medida') == 'h' ? 'selected' : '' }}>Hora</option>
                                        <option value="dia" {{ old('unidade_medida') == 'dia' ? 'selected' : '' }}>Dia</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4">
