...
@section('title', 'Editar Material - Diário de Obras')
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">
                                ...
                                Editar Material: {{ $material->nome_material }}
                            </h3>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('diario-obras.materiais.update', $material) }}" method="POST">
                                @csrf
                                @method('PUT')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('projeto_id') is-invalid @enderror" id="projeto_id" name="projeto_id" required>
                                                ...
                                                @foreach($projetos as $projeto)
                                                    <option value="{{ $projeto->id }}" {{ old('projeto_id', $material->projeto_id) == $projeto->id ? 'selected' : '' }}>
                                                        {{ $projeto->nome }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('tipo_movimento') is-invalid @enderror" id="tipo_movimento" name="tipo_movimento" required>
                                                ...
                                                <option value="entrada" {{ old('tipo_movimento', $material->tipo_movimento) == 'entrada' ? 'selected' : '' }}>Entrada</option>
                                                <option value="saida" {{ old('tipo_movimento', $material->tipo_movimento) == 'saida' ? 'selected' : '' }}>Saída</option>
                                                <option value="transferencia" {{ old('tipo_movimento', $material->tipo_movimento) == 'transferencia' ? 'selected' : '' }}>Transferência</option>
                                            </select>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('nome_material') is-invalid @enderror"
                                                   ...
                                                   value="{{ old('nome_material', $material->nome_material) }}" required>
                                            @error('nome_material')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('unidade_medida') is-invalid @enderror"
                                                   ...
                                                   value="{{ old('unidade_medida', $material->unidade_medida) }}" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('descricao') is-invalid @enderror"
                                              id="descricao" name="descricao" rows="3">{{ old('descricao', $material->descricao) }}</textarea>
                                    @error('descricao')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control @error('quantidade') is-invalid @enderror"
                                                   ...
                                                   value="{{ old('quantidade', $material->quantidade) }}"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control @error('data_movimento') is-invalid @enderror"
                                                   ...
                                                   value="{{ old('data_movimento', $material->data_movimento->format('Y-m-d')) }}" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('nota_fiscal') is-invalid @enderror"
                                                   ...
                                                   value="{{ old('nota_fiscal', $material->nota_fiscal) }}">
                                            @error('nota_fiscal')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('responsavel_id') is-invalid @enderror" id="responsavel_id" name="responsavel_id" required>
                                        ...
                                        @foreach($usuarios as $usuario)
                                            <option value="{{ $usuario->id }}" {{ old('responsavel_id', $material->responsavel_id) == $usuario->id ? 'selected' : '' }}>
                                                {{ $usuario->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('observacoes') is-invalid @enderror"
                                              id="observacoes" name="observacoes" rows="3">{{ old('observacoes', $material->observacoes) }}</textarea>
                                    @error('observacoes')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="{{ route('diario-obras.materiais.show', $material) }}" class="btn btn-secondary">
