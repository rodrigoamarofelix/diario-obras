...
@section('title', 'Galeria de Fotos - Diário de Obras')
...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row mb-3">
                <div class="col-12">
                    <a href="{{ route('diario-obras.fotos.create') }}" class="btn btn-primary">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="projeto">
                                ...
                                @foreach($fotos->pluck('projeto')->unique() as $projeto)
            ...
            <div id="galleryView" class="gallery-view active">
                <div class="gallery-container" id="galleryContainer">
                    ...
                    <div class="photo-card"
                        ...
                        <div class="photo-info">
                            ...
                            <div class="photo-meta">
                                ...
                                <br>
                                <i class="fas fa-project-diagram"></i> {{ $foto->projeto->nome }}
                                <br>
                    ...
                    <div class="col-12 text-center py-5">
                        ...
                        <p class="text-muted">Comece adicionando fotos ao seu projeto.</p>
                        <a href="{{ route('diario-obras.fotos.create') }}" class="btn btn-primary">
                            <i class="fas fa-plus"></i>
...
function filterPhotos() {
    ...
    cards.forEach(card => {
        ...
        const matchesProjeto = !projeto || cardProjeto === projeto;
        const matchesStatus = !status || cardStatus === status;

        if (matchesSearch && matchesCategoria && matchesProjeto && matchesStatus) {
...
document.getElementById('projeto').addEventListener('change', filterPhotos);
document.getElementById('status').addEventListener('change', filterPhotos);

// Modal Functions
function openModal(photoId) {
    // This would typically load photo data via AJAX
