    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{ route('dashboard') }}" class="brand-link">
                ...
                <span class="brand-text font-weight-light" style="font-size: 16px;">{{ config('app.name') }}</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <!-- Diário de Obras -->
                        <li class="nav-item {{ request()->routeIs('diario-obras.*') ? 'menu-open' : '' }}">
                            <a href="#" class="nav-link {{ request()->routeIs('diario-obras.*') ? 'active' : '' }}">
                                <i class="nav-icon fas fa-hard-hat text-warning"></i>
                                <p>
                                    Diário de Obras
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('diario-obras.dashboard') }}" class="nav-link {{ request()->routeIs('diario-obras.dashboard') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Dashboard</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('diario-obras.projetos.index') }}" class="nav-link {{ request()->routeIs('diario-obras.projetos.*') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Projetos/Obras</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('diario-obras.atividades.index') }}" class="nav-link {{ request()->routeIs('diario-obras.atividades.*') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Atividades</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('diario-obras.equipe.index') }}" class="nav-link {{ request()->routeIs('diario-obras.equipe.*') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Equipe</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('diario-obras.materiais.index') }}" class="nav-link {{ request()->routeIs('diario-obras.materiais.*') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Materiais</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('diario-obras.relatorios') }}" class="nav-link {{ request()->routeIs('diario-obras.relatorios*') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Relatórios</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('diario-obras.alertas') }}" class="nav-link {{ request()->routeIs('diario-obras.alertas') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Alertas</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('diario-obras.configuracoes') }}" class="nav-link {{ request()->routeIs('diario-obras.configuracoes') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Configurações</p>
                                    </a>
                                </li>
            ...
            <div class="p-3">
                ...
                <div class="form-group">
                    ...
                    <div class="small text-muted">
                        <p><strong>Sistema:</strong> {{ config('app.name') }}</p>
