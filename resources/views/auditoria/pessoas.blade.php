...
@section('page-title', 'Auditoria - Pessoas')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <!-- Filtros -->
                    <form method="GET" action="{{ route('auditoria.pessoas') }}" class="mb-4">
                        <div class="row">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <div>
                                        ...
                                        <a href="{{ route('auditoria.pessoas') }}" class="btn btn-secondary">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="text-center text-muted">
                                            ...
                                            Nenhuma auditoria de pessoas encontrada.
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
