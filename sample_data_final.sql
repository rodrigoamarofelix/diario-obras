-- Dados de exemplo para o sistema (estrutura correta final)
...
INSERT INTO projetos (id, nome, descricao, endereco, cidade, estado, cep, cliente, contrato, valor_total, data_inicio, data_fim_prevista, status, prioridade, responsavel_id, created_by, created_at, updated_at) VALUES
(1, 'Residencial Solar', 'Construção de residencial com sistema solar', 'Rua das Flores, 100', 'São Paulo', 'SP', '01234-567', 'João da Silva', 'CTR-001', 500000.00, '2025-01-01', '2025-12-31', 'em_andamento', 'alta', 1, 1, NOW(), NOW()),
(2, 'Comercial Plaza', 'Edifício comercial de 10 andares', 'Av. Comercial, 200', 'São Paulo', 'SP', '01234-567', 'Maria Santos', 'CTR-002', 2000000.00, '2025-02-01', '2025-11-30', 'em_andamento', 'alta', 1, 1, NOW(), NOW()),
(3, 'Reforma Escolar', 'Reforma completa da escola municipal', 'Rua da Escola, 300', 'São Paulo', 'SP', '01234-567', 'Prefeitura Municipal', 'CTR-003', 300000.00, '2025-03-01', '2025-10-31', 'planejamento', 'media', 1, 1, NOW(), NOW());

-- 7. Contratos (estrutura correta)
INSERT INTO contratos (id, numero, descricao, data_inicio, data_fim, gestor_id, fiscal_id, status, created_at, updated_at) VALUES
(1, 'CTR-001', 'Contrato de construção do residencial', '2025-01-01', '2025-12-31', 1, 2, 'ativo', NOW(), NOW()),
(2, 'CTR-002', 'Contrato de construção comercial', '2025-02-01', '2025-11-30', 2, 3, 'ativo', NOW(), NOW()),
(3, 'CTR-003', 'Contrato de reforma escolar', '2025-03-01', '2025-10-31', 3, 4, 'ativo', NOW(), NOW());

-- 8. Equipe de Obras (estrutura correta)
INSERT INTO equipe_obras (id, projeto_id, pessoa_id, status, created_at, updated_at) VALUES
(1, 1, 1, 'ativo', NOW(), NOW()),
(2, 1, 2, 'ativo', NOW(), NOW()),
(3, 2, 3, 'ativo', NOW(), NOW()),
(4, 3, 4, 'ativo', NOW(), NOW()),
