...
@section('page-title', 'Auditoria - Lotações')
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        ...
                        Auditoria de Lotações
                    </h3>
                </div>

                <div class="card-body">
                    <!-- Filtros -->
                    <form method="GET" action="{{ route('auditoria.lotacoes') }}" class="mb-4">
                        <div class="row">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <div>
                                        ...
                                        <a href="{{ route('auditoria.lotacoes') }}" class="btn btn-secondary">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="text-center text-muted">
                                            ...
                                            Nenhuma auditoria de lotações encontrada.
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
