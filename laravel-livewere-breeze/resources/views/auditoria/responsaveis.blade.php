...
@section('page-title', 'Auditoria - Responsáveis de Contratos')

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('auditoria.index') }}">Auditoria</a></li>
    <li class="breadcrumb-item active">Responsáveis Contratos</li>
@endsection
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        ...
                        Auditoria de Responsáveis de Contratos
                    </h3>
                </div>

                <div class="card-body">
                    <!-- Filtros -->
                    <form method="GET" action="{{ route('auditoria.responsaveis') }}" class="mb-4">
                        <div class="row">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <div>
                                        ...
                                        <a href="{{ route('auditoria.responsaveis') }}" class="btn btn-secondary">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="text-center text-muted">
                                            ...
                                            Nenhuma auditoria de responsáveis encontrada.
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
