            ...
            <div class="card">
                ...
                <form action="{{ route('medicao.store') }}" method="POST">
                                    ...
                                    <select class="form-control" id="catalogo_id" name="catalogo_id" required>
                                        ...
                                        @foreach($catalogos as $catalogo)
                                            <option value="{{ $catalogo->id }}"
                                                    ...
                                                    {{ old('catalogo_id') == $catalogo->id ? 'selected' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="lotacao_id" name="lotacao_id" required>
                                        ...
                                        @foreach($lotacoes as $lotacao)
                                            <option value="{{ $lotacao->id }}" {{ old('lotacao_id') == $lotacao->id ? 'selected' : '' }}>
                                                {{ $lotacao->nome }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="numero_medicao" name="numero_medicao"
                                           value="{{ $proximoNumero }}" readonly style="background-color: #f8f9fa;">
                                    <small class="form-text text-muted">Número gerado automaticamente pelo sistema</small>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="data_medicao" name="data_medicao"
                                           value="{{ old('data_medicao') }}" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="quantidade" name="quantidade"
                                           step="0.001" min="0.001" value="{{ old('quantidade') }}" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" id="valor_unitario" name="valor_unitario"
                                               step="0.01" min="0" value="{{ old('valor_unitario') }}" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('medicao.index') }}" class="btn btn-secondary">
